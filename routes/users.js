...
mongoose.connect('mongodb://localhost:27017/newGossip',{useUnifiedTopology:true,useNewUrlParser:true})
...
async function provideResources(username)
{
    ...
    const socket = await new Sockets({username,socketID:"None",active:true}).save();
}
